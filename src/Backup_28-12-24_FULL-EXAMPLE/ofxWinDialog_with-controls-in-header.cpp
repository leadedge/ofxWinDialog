            ...
            for (size_t i=0; i<pThis->controls.size(); i++) {
                ...
                if (pThis->controls[i].Type == "Static" && pThis->controls[i].Index == 1) {
                    if (LOWORD(wParam) == pThis->controls[i].ID) {
                        ...
                        DrawTextA(lpdis->hDC, pThis->controls[i].Title.c_str(), -1, &lpdis->rcItem, DT_CENTER);
                        // Set a hand cursor
         ...
         case WM_COMMAND:
             ...
             if (pThis->controls.size() > 0) {
                 ...
                 for (size_t i=0; i<pThis->controls.size(); i++) {
                     if (pThis->controls[i].Type == "Static" && pThis->controls[i].Index == 1) {
                         if (LOWORD(wParam) == pThis->controls[i].ID) {
                             if(!pThis->controls[i].Text.empty()) {
                                // Title is the text displayed, control text is the action taken
                     ...
                     for (size_t i=0; i<pThis->controls.size(); i++) {
                         ...
                         if (pThis->controls[i].Type == "Radio") {
                             ...
                             for (int j=0; j<=pThis->nRadioGroup; j++) {
                                 ...
                                 } // endif if j == pThis->pThis->pThis->pThis->controls[i].Group
